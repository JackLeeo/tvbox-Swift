...
class DetailViewModel: ObservableObject {
    ...
    private var isSpiderSource: Bool {
        guard let sourceKey = vodInfo?.sourceKey else { return false }
        return ApiConfig.shared.getSource(key: sourceKey)?.isSpiderSource ?? false
    }
